...
namespace ros2 {
  ...
  bool CarlaTransformPublisher::Init(const TopicConfig& config) {
  ...
  CarlaTransformPublisher::CarlaTransformPublisher(const char* ros_name, const char* parent, const char* ros_topic_name) :
