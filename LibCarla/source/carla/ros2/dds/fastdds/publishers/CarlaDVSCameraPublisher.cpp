...
namespace ros2 {
  ...
  bool CarlaDVSCameraPublisher::InitImage() {
    ...
    _impl->_participant = factory->create_participant(_impl->_config.domain_id, pqos);
    ...
    configure_qos(_impl->_config, wqos);
  ...
  bool CarlaDVSCameraPublisher::InitInfo() {
    ...
    pqos.name(_name);
    auto factory = efd::DomainParticipantFactory::get_instance();
    _info->_participant = factory->create_participant(_impl->_config.domain_id, pqos);
  ...
  bool CarlaDVSCameraPublisher::InitPointCloud() {
    ...
    pqos.name(_name);
    auto factory = efd::DomainParticipantFactory::get_instance();
    _point_cloud->_participant = factory->create_participant(_impl->_config.domain_id, pqos);
