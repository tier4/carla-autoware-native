...
#include "carla/ros2/dds/fastdds/types/String.h"
#include "carla/ros2/dds/fastdds/types/StringPubSubTypes.h"
#include "carla/ros2/dds/fastdds/listeners/BasicListener.h"
...
namespace ros2 {
  ...
  bool BasicSubscriber::Init(const TopicConfig& config) {
  ...
  BasicSubscriber::BasicSubscriber(void* actor, const char* ros_name, const char* parent, const char* ros_topic_name) :
