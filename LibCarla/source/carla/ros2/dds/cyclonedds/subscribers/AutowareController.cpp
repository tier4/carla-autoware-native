...
// <Message, MessagePubSubType> and calls MessagePubSubType().getName().
// These minimal stubs satisfy that interface for CycloneDDS, which has no
// real PubSubType classes.
// ---------------------------------------------------------------------------
...
: public AutowareSubscriber<autoware_control_msgs_msg_Control, autoware_control_msgs::msg::ControlPubSubType>
{
public:
...
: public AutowareSubscriber<autoware_vehicle_msgs_msg_GearCommand, autoware_vehicle_msgs::msg::GearCommandPubSubType>
{
public:
...
: public AutowareSubscriber<autoware_vehicle_msgs_msg_TurnIndicatorsCommand, autoware_vehicle_msgs::msg::TurnIndicatorsCommandPubSubType>
{
public:
...
: public AutowareSubscriber<autoware_vehicle_msgs_msg_HazardLightsCommand, autoware_vehicle_msgs::msg::HazardLightsCommandPubSubType>
{
public:
...
: public AutowareSubscriber<tier4_vehicle_msgs_msg_VehicleEmergencyStamped, tier4_vehicle_msgs::msg::VehicleEmergencyStampedPubSubType>
{
public:
...
: public AutowareSubscriber<autoware_vehicle_msgs_msg_Engage, autoware_vehicle_msgs::msg::EngagePubSubType>
{
public:
