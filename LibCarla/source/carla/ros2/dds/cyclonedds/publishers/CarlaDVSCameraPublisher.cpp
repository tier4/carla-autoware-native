...
namespace ros2 {
  ...
  bool CarlaDVSCameraPublisher::InitInfo() {
    _info->_participant = dds_create_participant(_impl->_config.domain_id, nullptr, nullptr);
    ...
    _info->_writer = dds_create_writer(_info->_participant, _info->_topic, qos_info, nullptr);
  ...
  bool CarlaDVSCameraPublisher::InitPointCloud() {
    _point_cloud->_participant = dds_create_participant(_impl->_config.domain_id, nullptr, nullptr);
    ...
    dds_qos_t* qos_pc = dds_create_qos();
    configure_cyclone_qos(_impl->_config, qos_pc);
    _point_cloud->_writer = dds_create_writer(_point_cloud->_participant, _point_cloud->_topic, qos_pc, nullptr);
    dds_delete_qos(qos_pc);
